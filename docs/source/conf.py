# -*- coding: utf-8 -*-
#
# notify documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    ('index',
     'notify.tex',
     u'notify Documentation',
     u"aprashedahmed", 'manual'),
]
...
texinfo_documents = [
    ('index', 'notify', u'notify Documentation',
     u"aprashedahmed", 'notify',
     'Centralized place for programmatic notifications', 'Miscellaneous'),
]
